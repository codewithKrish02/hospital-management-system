<%-- 
    Document   : viewReception
    Created on : May 3, 2019, 4:27:03 PM
    Author     : prath
--%>
...
<%         
        ...
        <center>
            <h1>Receptionist Registrations</h1>
        <table border="1">
            <tr>
                <td>FirstName</td>
                <td>LastName</td>
            ...
            <tbody>
                <%
                    ...
                    ResultSet rs=st.executeQuery("select * from receptionregistration");
                    while(rs.next())
                    {
                    %>
                    <tr>
                   ...
                   <!-- <td><%=rs.getString(10)%></td>
                    ...
                    <td><a href="delete_rec_reg.jsp?email=<%=rs.getString(3)%>">Delete</a></td>

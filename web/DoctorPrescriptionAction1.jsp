...
<html>
    ...
    <body>
        <%
            ...
            String Decrip=request.getParameter("addr");
                       
            
            PreparedStatement ps=con.prepareStatement("INSERT INTO DoctorPrescription VALUES(?,?,?,?,?,?,?,?,?)");
            ...
            ps.setString(6, age);
            ps.setString(7, dateofapp);
            ps.setString(8, Decrip);
            ps.setString(9, dept);
            ps.executeUpdate();

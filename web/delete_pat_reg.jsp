...
<h1 align="center">DELETE PATIENT REGISTRATION FORM</h1>
<div class="register">
<h2>Register here</h2>
<form id="register" method="post" action="delete_pat.jsp">
    <% 
       String p=request.getParameter("email");
       Statement st=con.createStatement();
                    ResultSet rs=st.executeQuery("select * from patientregistration where EmailId='"+p+"'");
                    while(rs.next()){
...
<textarea cols=20 rows=10 placeholder="Enter address" name="addr" id="name" required="" value="<%=rs.getString(8)%>"></textarea><br><br>
<label>Occupation</label><br>
<input type="text" name="occupation" id="name" required="" placeholder="Enter Occupation" value="<%=rs.getString(9)%>"/><br><br>
<label>State</label><br>
<select id="state" name="state" value="<%=rs.getString(10)%>">
    <option>Select</option>

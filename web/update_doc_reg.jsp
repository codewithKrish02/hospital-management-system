...
<h1 align="center">UPDATE DOCTOR REGISTRATION FORM</h1>
<div class="register">
<h2>Update here</h2>
<form id="register" method="post" name="f" action="update_doc.jsp">
    <% 
...
<input type="text" placeholder="Enter address" name="addr" id="name" required="" value="<%=rs.getString(14)%>"><br><br>
...
<input type="submit" value="Update" id="sub" required="">

...
<h1 align="center">RECEPTIONIST PROFILE</h1>
<div class="register">
<h2>Register here</h2>
<form id="register" method="post" action="update_rec.jsp">
     <% 
         String k=(String)session.getAttribute("id");
       String p=request.getParameter("email");
       Statement st=con.createStatement();
                    ResultSet rs=st.executeQuery("select * from receptionregistration where EmailId='"+k+"'");
                    while(rs.next()){
...
<input type="text" name="male" id="name" value="<%=rs.getString(5)%>"><br><br>
...
<input type="text" id="name" value="<%=rs.getString(9)%>"><br><br>
...
<div align="center"><a href="update_rec_reg.jsp?email=<%=rs.getString(3)%>"> <button id="sub">Update Profile</button></a></div>
<% }
                    %>
</div>
</body>

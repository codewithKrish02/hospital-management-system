...
<h1 align="center">DELETE DOCTOR REGISTRATION FORM</h1>
<div class="register">
<h2>Register here</h2>
<form id="register" method="post" action="delete_doc.jsp">
    <% 
       String p=request.getParameter("email");
       Statement st=con.createStatement();
                    ResultSet rs=st.executeQuery("select * from doctorregistration where EmailID='"+p+"'");
                    while(rs.next()){
...
<textarea cols=20 rows=10 placeholder="Enter address" name="addr" id="name" required="" value="<%=rs.getString(14)%>"></textarea><br><br>
...
<input type="submit" value="Delete" id="sub" required="">
